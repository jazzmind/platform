  ...
  try {
    ...
    if (existingRegistration) {
      return {
        ...
        errors: {
          _form: [
            "You have already registered for this event. We will be in touch soon with more details.",
          ],
        },
      };
    }
    ...
    try {
      ...
      const registrationRow = [data.name, data.email, data.organization, timestamp, "pending"]
    ...
    const fromEmail = process.env.EMAIL_FROM || "wes@sonnenreich.com";
