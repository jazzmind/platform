      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-white">1. Create an Event</h3>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-white">3. Get Optimized Schedule</h3>
              <p className="text-gray-600 dark:text-gray-300">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className="w-full md:w-1/2 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
            <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Create a New Schedule</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              To create a new scheduling event, you&apos;ll need an access code. This helps prevent spam and unauthorized use.
            </p>
          ...
          <div className="w-full md:w-1/2 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
            <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Access a Shared Schedule</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              If someone shared a scheduling link with you, you can access it directly to provide your availability.
            </p>
            
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">
              The link format is: <span className="font-mono">https://wessonnenreich.com/scheduler/EVENT_ID</span>
            </p>
          </div>
        </div>
      </div>
