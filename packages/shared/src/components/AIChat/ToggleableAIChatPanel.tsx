...
import { ChatPanelProps } from "./AIChatPanel";
...
interface ToggleableAIChatPanelProps extends ChatPanelProps {
  isInitiallyOpen?: boolean;
}

export default function ToggleableAIChatPanel({
  isInitiallyOpen = false,
  ...chatPanelProps
}: ToggleableAIChatPanelProps) {
