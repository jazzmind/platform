...
export type EntityType = 'opportunity' | 'proposal' | 'organization';
...
export interface ContentGenerator {
  ...
  generateSectionContent(sectionType: string, context: GenerationContext): Promise<ContentGenerationResult>;
  improveContent(existingContent: string, requirements: string, context: GenerationContext): Promise<ContentGenerationResult>;
}
